        ...
        <>
            <div className={styles.main} style={{ backgroundColor: colorMode === 'dark' ? 'black' : 'white' }}>
                ...
                <div className={`${styles.navContent} ${styles.hideOnSmall}`} style={{ fontSize: fontSize, color: colorMode === 'dark' ? 'yellow' : 'black' }}>
                    <div className={styles.navItem} onClick={() => goTo('/officer/home')}><p>Home</p></div>
                    <div className={styles.navItem} onClick={() => goTo('/officer/dashboard')}><p>Dashboard</p></div>
                    <div className={styles.navItem} onClick={() => goTo('/officer/publicQueries')}><p>Public Queries</p></div>
                </div>
                ...
                <div className={styles.pModal}>
                    {user ? (
                        <div className={styles.modalContent}>
                            <p><strong>OfficerName:</strong> {user.username}</p>
                            <p><strong>OfficerID:</strong> {user.AdminId}</p>
