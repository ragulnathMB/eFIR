...
const UserDashboardPage = () => {
    ...
    const [viewNotifications, setViewNotifications] = useState(false); // New state for controlling view
    ...
    useEffect(() => {
        const fetchFIRs = async () => {
            try {
                const response = await axios.get(`http://localhost:5000/UserDashBoard/${user.userId}`,{withCredentials:true});
    ...
    const handleNotificationsClick = () => {
        setViewNotifications(true); // Set to show notifications
    };
    const handleNotificationsCloseClick = () => {
        setViewNotifications(false); // Set to close notifications
    };
    ...
    return (
        <div className={styles.dashboard} style={containerStyle}>
            <div className={styles.sidebar} style={sidebarStyle}>
                <h2>My Dashboard</h2>
                <ul>
                    <li><a style={{ cursor: 'pointer' }} onClick={goToHome}>Home</a></li>
                    <li><a style={{ cursor: 'pointer' }} onClick={handleNotificationsCloseClick}>My FIRs</a></li>
                    <li><a style={{ cursor: 'pointer' }} onClick={handleNotificationsClick}>Notifications</a></li>
                    <li><a style={{ cursor: 'pointer' }} onClick={goToContact}>Contact Support</a></li>
                </ul>
            </div>

            <div className={styles.mainContent}>
                {viewNotifications ? (
                    // Show notifications content if viewNotifications is true
                    <NotificationContent userId={user.userId} />
                ) : (
                    // Show the FIR overview content
                    <>
